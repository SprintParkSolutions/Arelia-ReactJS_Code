...
function useDeferredActivation<T extends HTMLElement>(
...
const QUOTE_BACKGROUND_LAYER = homePageOptimizedImagePath(
  "quote-background.webp",
);
const QUOTE_FOREGROUND_LAYER = homePageOptimizedImagePath(
  "quote-background.webp",
);
...
const heroShowcaseSlides: readonly HeroShowcaseSlide[] = [
  ...
  },
  {
    ...
    support:
      "Every design starts with your comfort, your taste, and your way of living.",
    title: "Designed",
  },
  {
    ...
    support:
      "Preview 3D designs and see exactly how your home will look before execution begins.",
  ...
  },
  {
    ...
    support:
      "You never have to chase updates because the important moments are shared with clarity, every day.",
    title: "Daily Updates",
  },
  {
    ...
    imagePosition: "center center",
    support:
      "From cost to progress, Arelia keeps the journey open and understandable from day one.",
    title: "Transparency",
  },
  {
    accent: "End to End",
    ...
    imagePosition: "center center",
    support:
      "Arelia stays involved throughout, keeping the experience calm, organized, and supported.",
    title: "Execution",
  },
] as const;
...
function TransparencyIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
        d="M12 4 19.5 12 12 20 4.5 12 12 4Z"
        stroke="currentColor"
        strokeWidth="1.5"
      />
      <path
...
function MobileIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      ...
      />
      <path
        d="M10 6.5h4M9.5 11.5h5M9.5 14.5h3.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
const whyChooseFeatures: readonly FeatureItem[] = [
  ...
  },
  {
    ...
    description:
      "Stay financially in control with structured estimation and real-time cost tracking.",
  ...
  },
  {
    ...
    description:
      "Track updates, milestones, and execution progress with full visibility.",
  ...
  },
  {
    ...
    description:
      "Monitor progress, updates, and communication anytime through mobile access.",
...
function HomeHeroSection() {
  ...
  const [loadedSlideIndexes, setLoadedSlideIndexes] = useState<
    readonly number[]
  >([heroShowcaseSlides.length - 1, 0, 1]);
  ...
  const queueSlideChange = (direction: 1 | -1) => {
    ...
    transitionTimeoutRef.current = window.setTimeout(() => {
      setActiveIndex((currentIndex) => {
        ...
        return (
          (currentIndex - 1 + heroShowcaseSlides.length) %
          heroShowcaseSlides.length
        );
      });
  ...
  useEffect(() => {
    const frameId = window.requestAnimationFrame(() => {
      ...
      setLoadedSlideIndexes((currentIndexes) => {
        ...
        return Array.from(
          new Set([...currentIndexes, previousIndex, activeIndex, nextIndex]),
        );
      });
    });
  ...
  return (
    <section className="home-page__hero">
      ...
      <div
        className="home-page__hero-glow home-page__hero-glow--left"
        aria-hidden="true"
      />
      <div
        className="home-page__hero-glow home-page__hero-glow--right"
        aria-hidden="true"
      />
      <div className="home-page__content home-page__content--showcase">
        <div className="home-page__showcase-panel">
          <div className="home-page__showcase-layout">
            ...
            <div
              className="home-page__showcase-visual-shell"
              aria-hidden="true"
            >
...
function WhyChooseSection() {
  const { ref: sectionRef, isActive } =
    useDeferredActivation<HTMLElement>("350px 0px");
  ...
  useEffect(() => {
    ...
    whyChooseFeatures
      .flatMap((feature) => [feature.image, feature.thumbnail])
      .forEach((src) => {
  ...
  useEffect(() => {
    ...
    loadGsapBundle().then(({ gsap }) => {
      ...
      nextBackground.className =
        "why-choose-luxe__image why-choose-luxe__image--incoming";
      nextBackground.style.backgroundImage = `url(${nextFeature.image})`;
      imageLayerRef.current.appendChild(nextBackground);

      const timeline = gsap.timeline({ defaults: { ease: "power3.out" } });
      timeline.to(
        navRef.current.querySelectorAll(".why-choose-luxe__nav-item"),
        {
          x: (_index: number, target: Element) =>
            target.classList.contains("is-active") ? 10 : 0,
          duration: 0.46,
          stagger: 0.02,
        },
        0,
      ...
      timeline.fromTo(
        nextBackground,
        { autoAlpha: 0, scale: 1.1, xPercent: 4 },
        { autoAlpha: 1, scale: 1, xPercent: 0, duration: 0.8 },
        0,
      );
      timeline.to(
        activeImageRef.current,
        { autoAlpha: 0, scale: 0.96, xPercent: -2, duration: 0.7 },
        0,
      );
      timeline.fromTo(
        detailImageRef.current,
        { autoAlpha: 0.32, xPercent: 12, scale: 1.08 },
        { autoAlpha: 1, xPercent: 0, scale: 1, duration: 0.68 },
        0.08,
      );
      timeline.call(() => {
      ...
      timeline.fromTo(
        ...
        { autoAlpha: 1, y: 0, filter: "blur(0px)", duration: 0.56 },
      );
  ...
  useEffect(() => {
    ...
    const intervalId = window.setInterval(() => {
      setActiveIndex(
        (currentIndex) => (currentIndex + 1) % whyChooseFeatures.length,
      );
    }, 1800);
  ...
  return (
    <section
      ref={sectionRef}
      className={`why-choose-luxe luxury-section--wide${isAutoPaused ? "" : " is-auto-cycling"}`}
    >
      ...
      <div className="why-choose-luxe__inner">
        <header className="why-choose-luxe__header why-choose-luxe__reveal">
          ...
          <h2 className="why-choose-luxe__headline">
        ...
        >
          <div
            className="why-choose-luxe__accent why-choose-luxe__accent--left"
            aria-hidden="true"
          >
          ...
          <nav
            ref={navRef}
            className="why-choose-luxe__nav why-choose-luxe__reveal"
            aria-label="Why Choose Arelia features"
          >
            {whyChooseFeatures.map((feature, index) => (
              ...
              >
                <span className="why-choose-luxe__nav-number">
                  {feature.number}
                </span>
                <span
                ...
                <span className="why-choose-luxe__nav-copy">
                  <span className="why-choose-luxe__nav-title">
                    {feature.title}
                  </span>
                  <span
                    className="why-choose-luxe__nav-arrow"
                    aria-hidden="true"
                  >
          ...
          <article
            ref={cardRef}
            className="why-choose-luxe__card why-choose-luxe__reveal"
            data-magnetic
          >
            <div
              ref={imageLayerRef}
              className="why-choose-luxe__image-layer"
              aria-hidden="true"
            >
              <div
                ref={activeImageRef}
                className="why-choose-luxe__image"
            ...
            <div
              className="why-choose-luxe__card-accent why-choose-luxe__card-accent--top"
              aria-hidden="true"
            >
              <svg viewBox="0 0 220 120" fill="none">
                <path
                  d="M12 60h104c18 0 26-14 42-14s22 14 50 14"
                  stroke="currentColor"
                  strokeWidth="1.3"
                  strokeLinecap="round"
                />
            ...
            <div
              className="why-choose-luxe__card-accent why-choose-luxe__card-accent--bottom"
              aria-hidden="true"
            >
            ...
            <div ref={contentRef} className="why-choose-luxe__content">
              ...
              <div className="why-choose-luxe__copy">
                ...
                <h3 className="why-choose-luxe__card-title">
                  {activeFeature.title}
                </h3>
                <p className="why-choose-luxe__description">
            ...
            <div className="why-choose-luxe__detail-strip" aria-hidden="true">
              <div
                ref={detailImageRef}
                className="why-choose-luxe__detail-image"
                style={{ backgroundImage: `url(${activeFeature.thumbnail})` }}
              />
            </div>
          </article>
        </div>
  ...
  return (
    <section ref={sectionRef} className="ssc-section">
      ...
      <header className="ssc-header">
        ...
        >
          At Arelia, every project is built on innovative interior design,
          transparent workflow, and unwavering commitment , from first enquiry
          to final handover.
        </motion.p>
...
function QuoteSectionSection() {
  const { ref: sectionRef, isActive } =
    useDeferredActivation<HTMLElement>("300px 0px");
  ...
  return (
    <section ref={sectionRef} className="quote-section">
      <div
        ref={backgroundRef}
        className="quote-section__layer quote-section__layer--background"
        style={{ backgroundImage: `url(${QUOTE_BACKGROUND_LAYER})` }}
      />
      <div
        ref={foregroundRef}
        className="quote-section__layer quote-section__layer--foreground"
        style={{ backgroundImage: `url(${QUOTE_FOREGROUND_LAYER})` }}
      />
    ...
    <div className="stats__digits">
      {characters.map((character, index) => (
        <span key={`${character}-${index}`} className="stats__digit-slot">
          {/\d/.test(character) ? (
            <span
              className={`stats__digit-wheel${isActive ? " is-active" : ""}`}
...
function StatsSection() {
  const { ref: sectionRef, isActive: isSectionActive } =
    useDeferredActivation<HTMLElement>("300px 0px");
  const [isActive, setIsActive] = useState(false);
      ...
      <div className="client-testimonials__card-inner">
        <div className="client-testimonials__image-wrap">
          <div className="client-testimonials__avatar-shell" aria-hidden="true">
            <div className="client-testimonials__avatar">
        ...
        <div className="client-testimonials__copy">
          <div
            className="client-testimonials__stars"
...
function ClientTestimonialsSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="client-testimonials luxury-section luxury-section--wide"
    >
      <div className="client-testimonials__backlight" aria-hidden="true" />
      <div
        className="client-testimonials__dust client-testimonials__dust--one"
        aria-hidden="true"
      />
      <div
        className="client-testimonials__dust client-testimonials__dust--two"
        aria-hidden="true"
      />
      <div
        className="client-testimonials__edge client-testimonials__edge--left"
        aria-hidden="true"
      />
      <div
        className="client-testimonials__edge client-testimonials__edge--right"
        aria-hidden="true"
      />
      ...
      <div className="client-testimonials__header client-testimonials__reveal">
        ...
        <p className="client-testimonials__subtitle">
          From modern home interiors to commercial office designs and luxury
          hospitality spaces , here's what our clients say about their Arelia
...
function ContactCTASection({
  ...
  return (
    <section
      ref={sectionRef}
      className="contact-cta luxury-section luxury-section--wide"
    >
      <div
      ...
      <div className="contact-cta__content">
        <p className="contact-cta__eyebrow contact-cta__reveal">
          YOUR JOURNEY STARTS HERE
        </p>
        <h2 className="contact-cta__reveal">
          Ready to Transform Your Space, or Want to Explore More?
        </h2>
        <p className="contact-cta__copy contact-cta__reveal">
          Let's create a personalized interior design consultation experience
          that feels thoughtful, elegant, and uniquely yours , from first
          conversation to final handover.
        </p>
        <button
          type="button"
          onClick={onOpenConsultation}
          className="contact-cta__button contact-cta__reveal"
          data-magnetic
        >
